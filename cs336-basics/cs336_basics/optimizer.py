...
class AdamW(torch.optim.Optimizer):
  ...
  The optimizer is not most accurate and optimized.
  
  1. the params should be fp32 but it is the same as
  the input (can be fp16, bf16). And as a result it
  doesn't have a full accuracy copy of the params.
  
  2. The ops are not fused.
  """
